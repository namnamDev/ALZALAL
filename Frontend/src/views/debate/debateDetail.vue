  ...
  <div class="animate__animated animate__fadeInUp my-4 main">
    <div class="article-box col-lg-6 col-md-10 col-sm-9 col-10">
      ...
      <div class="bottom my-3">
        ...
        <button class="my-3 create-comment-btn" @click="clickAlgoInput">
          댓글쓰기
        </button>
...
export default {
  ...
  mounted() {
    ...
    if (stompClient != null) {
      //app.vue에서 소켓 연결 하기전에 여기서 가져다 쓰면 에러떠서 1초 기다려줌
      let tmp = setInterval(() => {
        this.socketSubscription = stompClient.subscribe(
          "/discuss/" + this.discussionNo,
