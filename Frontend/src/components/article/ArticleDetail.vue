<template>
  <div
    class="animate__animated animate__fadeInUp my-4 main"
    v-if="articleDetail"
  >
    <div class="article-box col-lg-6 col-md-10 col-sm-9 col-10">
      <div>
        ...
        <div class="row">
          <div class="col clickName">
            <span @click="clickName" class="member-name">{{
      ...
      <div class="bottom my-3">
        <div>
          ...
          <button class="my-3 create-comment-btn" @click="clickCreateComment">
            댓글쓰기
          </button>
        ...
        <div
          class="row"
          v-for="(comment, idx) in getArticleComments"
          :key="idx"
        >
...
export default {
  ...
  methods: {
    ...
    clickName: function () {
      ...
      this.$router.push({
        name: "profilePage",
        params: { userPk: this.articleDetail.member.no },
      });
    },
  },
};
