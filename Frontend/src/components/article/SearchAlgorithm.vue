<template>
  ...
  <infinite-loading @infinite="infiniteHandlerDate" spinner="sprial" v-if="isDate">
    <div
      slot="no-more"
  ...
  <infinite-loading @infinite="infiniteHandlerLike" spinner="sprial" v-else>
    <div
      slot="no-more"
      style="color: rgb(102, 102, 102); font-size: 14px; padding: 10px 0px"
    >
